...
<body>
<div class="container" >
		<h1 style="font-size: 20px">Sistem Pinjaman Barang Di Unit ICT</h1>
		<form action="Staff login/login_check.php" method="post">
		<div>
			<center>
					<div>
		  ...
		  <div class="field-container">
			...
			<label>Username</label>
			  <input type="text" name="username" required placeholder="Username (IC Number)">
			  </div>
		  ...
		  <div class="field-container" style="margin-left: 80px;">
			...
			<ul >
				<li class="m-b-8">
					...
					<a href="process/resetPassword.php" class="txt2">
						Password?
					</a>
				</li>
				...
				<li>
					...
					<a href="process/register.php" class="txt2">
						Daftar Masuk
							</a>
						</li>
					</ul>
