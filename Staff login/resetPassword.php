...
<html lang="en">
<head>
	<title>Staff | Tukar Kata Laluan</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-15 p-b-2110">
				...
				<form name = "myForm" method= POST action= "password_check.php" class="login100-form validate-form " onSubmit="return(validate())">
					<span class="login100-form-title p-b-30">
						Tukar Password
					</span>
					<div class="wrap-input100 validate-input m-b-30" data-validate="Masukkan Username">
						<input class="input100" type="text" name="username" placeholder="Username (IC Number)">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-30" data-validate="vMasukkan Password">
